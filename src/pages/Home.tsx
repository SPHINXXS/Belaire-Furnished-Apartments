...
const HOMES: Home[] = [
  {
    ...
    gallery: [
      "/images/K8/K8 main image.jpg",
      "/images/K8/K8 couch.jpg",
      "/images/K8/K8 kitchen.jpg",
      "/images/K8/K8 table.jpg",
      "/images/K8/K8-image (1).jpeg",
      "/images/K8/K8-image (2).jpeg",
      "/images/K8/K8-image (3).jpeg",
      "/images/K8/K8-image (4).jpeg",
      "/images/K8/K8-image (5).jpeg",
      "/images/K8/K8-image (6).jpeg",
      "/images/K8/K8-image (7).jpeg",
    ],
  ...
  },
  {
    ...
    price: 3500,
    rating: "4.91",
    image: "/images/K8/LUXORE/Luxore (1).jpeg",
    gallery: [
      "/images/K8/LUXORE/Luxore (1).jpeg",
      "/images/K8/LUXORE/Luxore (2).jpeg",
      "/images/K8/LUXORE/Luxore (3).jpeg",
      "/images/K8/LUXORE/Luxore (4).jpeg",
      "/images/K8/LUXORE/Luxore (5).jpeg",
      "/images/K8/LUXORE/Luxore (6).jpeg",
      "/images/K8/LUXORE/Luxore (7).jpeg",
      "/images/K8/LUXORE/Luxore (8).jpeg",
    ],
    badge: "Popular stay",
    location: "Syokimau",
    bedrooms: "1 bedroom",
  ...
  },
  {
    ...
    gallery: [
      ...
      "/images/K8/JIJI/Jiji (3).jpeg",
      "/images/K8/JIJI/Jiji (4).jpeg",
      "/images/K8/JIJI/Jiji (5).jpeg",
    ],
    badge: "Guest favorite",
    location: "Ruaka",
    bedrooms: "Studio",
  ...
  },
  {
    ...
    price: 3000,
    rating: "4.88",
    image: "/images/K8/HOME/Home (1).jpeg",
    gallery: [
      "/images/K8/HOME/Home (1).jpeg",
      "/images/K8/HOME/Home (2).jpeg",
      "/images/K8/HOME/Home (3).jpeg",
      "/images/K8/HOME/Home (4).jpeg",
      "/images/K8/HOME/Home (5).jpeg",
      "/images/K8/HOME/Home (6).jpeg",
    ],
    badge: "Top rated",
    location: "Ruaka",
    bedrooms: "1 bedroom",
  ...
  },
  {
    ...
    price: 3000,
    rating: "4.98",
    image: "/images/K8/Thindigua/thindigue (5).jpg",
    gallery: [
      "/images/K8/Thindigua/thindigue (5).jpg",
      "/images/K8/Thindigua/thindigue (4).jpg",
      "/images/K8/Thindigua/thindigue (3).jpg",
      "/images/K8/Thindigua/thindigue (6).jpg",
      "/images/K8/Thindigua/thindigue (7).jpg",
      "/images/K8/Thindigua/thindigue (8).jpg",
      "/images/K8/Thindigua/thindigue (1).jpg",
      "/images/K8/Thindigua/thindigue (2).jpg",
    ],
    badge: "Rare find",
    location: "Thindigua",
    bedrooms: "1 bedroom",
  ...
  },
  {
    ...
    price: 3000,
    rating: "4.92",
    image: "/images/K8/Greenzone/Greenzone (1).jpg",
    gallery: [
      "/images/K8/Greenzone/Greenzone (1).jpg",
      "/images/K8/Greenzone/Greenzone (2).jpg",
      "/images/K8/Greenzone/Greenzone (3).jpg",
      "/images/K8/Greenzone/Greenzone (4).jpg",
      "/images/K8/Greenzone/Greenzone (5).jpg",
      "/images/K8/Greenzone/Greenzone (6).jpg",
        ...
        <main>
          ...
          <section className="mx-auto max-w-7xl px-6 py-8 lg:px-10">
            <div className="mb-6 flex items-center justify-between gap-4">
              ...
              <button type="button" onClick={() => navigate("/rooms")} className="rounded-full border border-[#e6d8c8] bg-[#fbf7f1] px-4 py-2 text-sm font-medium shadow-sm transition hover:-translate-y-0.5">
                View all
              </button>
            </div>
